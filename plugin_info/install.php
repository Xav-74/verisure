...
function verisure_update() {
	...
	message::add('verisure', 'Merci pour la mise à jour du plugin Verisure. Consultez les notes de version ( https://xav-74.github.io/Documentation/verisure/fr_FR/changelog ) avant utilisation et n\'hésitez pas à laisser un avis sur le Market Jeedom !');
