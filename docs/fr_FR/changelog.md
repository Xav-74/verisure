...
Première version du plugin Verisure
 ...
 - Fonctions : activation en mode total, activation en mode nuit, désactivation, récupération du statut de l'alarme (en manuel ou en automatique (toutes les 30 min))
