				...
				if (data.state != 'ok' || data.result == null) {
					...
					if ( data.result['type'] == "devices" ) {
						...
						for(j = 0; j < nbsp ; j++) {
							...
							else if (data.result['res'][j]['type'] == "TI" || data.result['res'][j]['type'] == "VV" || data.result['res'][j]['type'] == "VK") { tr += '<input type="text" class="eqLogicAttr form-control input-sm" value="Lecteur de badge" readonly="true" data-l1key="configuration" data-l2key="devices" data-l3key="smartplugModel'+j+'">'; }
